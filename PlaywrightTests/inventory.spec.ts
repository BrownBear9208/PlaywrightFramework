...
test.describe('Inventory - Product Listing', () => {
  ...
  test('TC-102 | Adding multiple products increments the cart badge correctly', { tag: '@regression' }, async ({ inventoryPage }) => {
    await inventoryPage.addItemToCartByName('Sauce Labs Backpack');
...
test.describe('Inventory - Sorting', () => {
  ...
  test('TC-110 | Sort by Name (A to Z) returns alphabetical order', { tag: '@regression' }, async ({ inventoryPage }) => {
  ...
  test('TC-111 | Sort by Name (Z to A) returns reverse alphabetical order', { tag: '@regression' }, async ({ inventoryPage }) => {
  ...
  test('TC-112 | Sort by Price (Low to High) returns ascending price order', { tag: '@regression' }, async ({ inventoryPage }) => {
  ...
  test('TC-113 | Sort by Price (High to Low) returns descending price order', { tag: '@regression' }, async ({ inventoryPage }) => {
...
test.describe('Inventory - Navigation', () => {
  ...
  test('TC-120 | Clicking a product name opens the product detail page', { tag: '@smoke' }, async ({ inventoryPage, itemDetailPage }) => {
  ...
  test('TC-123 | Sidebar "About" link navigates to saucelabs.com', { tag: '@regression' }, async ({ page, inventoryPage }) => {
