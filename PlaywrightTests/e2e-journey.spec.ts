...
test.describe('E2E - Purchase Workflows', () => {
  test('TC-500 | Single-item purchase from browse to order confirmation', { tag: '@smoke' }, async ({
  ...
  test('TC-501 | Multi-item purchase with cart modification and price verification', { tag: '@smoke' }, async ({
    page, inventoryPage, cartPage, checkoutPage
  }) => {
    await page.goto('/inventory.html');
  ...
  test('TC-502 | Purchase via product detail page with mixed add-to-cart sources', { tag: '@regression' }, async ({
    page, inventoryPage, itemDetailPage, cartPage, checkoutPage
  }) => {
    await page.goto('/inventory.html');
  ...
  test('TC-503 | Abandoned checkout preserves cart state across cancellation', { tag: '@regression' }, async ({
    page, inventoryPage, cartPage, checkoutPage
  }) => {
    await page.goto('/inventory.html');
